...
const getItemsToBeScheduledDW = (district) => {
  return axios.get('http://localhost:3001/admin/scheduletrainto', {
...
const scheduleOrdersToTrain = (orderID, trainID) => {
  return axios.post('http://localhost:3001/admin/scheduletrainto', {
    orderID,
    trainID,
  });
};
