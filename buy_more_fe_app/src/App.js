...
class App extends React.Component {
  ...
  render() {
    ...
    const store = (
      <div>
        ...
        <Routes>
          <Route
            path="/store"
            element={<StoreManager store_id={this.state.customer.store_id} />}
          />
          <Route
            path="/store/setroutes"
            element={<SetRoutes store_id={this.state.customer.store_id} />}
          />
          <Route
            path="/store/driverondelivery"
            element={<DriverOnTrip store_id={this.state.customer.store_id} />}
          />
          <Route
            path="/store/ordersontrain"
            element={<OrdersOnTrain store_id={this.state.customer.store_id} />}
          />
          <Route
            path="/store/neworder"
            element={<OrderedProduct store_id={this.state.customer.store_id} />}
          />
          <Route
            path="/store/finishedorder"
            element={<FinishedOrders store_id={this.state.customer.store_id} />}
          />
          <Route
            path="/store/scheduledorder"
            element={<ScheduledOrder store_id={this.state.customer.store_id} />}
          />
          <Route
            path="/store/scheduletruck"
            element={<ScheduleTruck store_id={this.state.customer.store_id} />}
          />
          <Route
            path="/store/addnewworker"
            element={<RegisterWorker store_id={this.state.customer.store_id} />}
          />
      ...
      <div>
        ...
        <Routes>
          ...
          <Route
            path="/history"
            element={
              <OrderedProduct customer_id={this.state.customer.customer_id} />
            }
          />
    ...
    if (this.state.customer.type === 'active' && this.state.role === 'normal') {
      ...
      this.state.customer.type === 'admin' &&
